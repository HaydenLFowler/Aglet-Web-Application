...
namespace AgletCoreMVC.Data
{
    public static class DbInitialiser
    {
        ...
        private static void InitialiseLaces(ApplicationDbContext context)
        {
            ...
            var laces = new Lace[]
            {
                new Lace {Colour = Colours.Black, Print = "Blue Lace", Brand = Brands.Nike, Length = 10, Price = 3.35m, ImageURL = "Redshoe.jpg", Description = "One of the best"},
                new Lace {Colour = Colours.Green, Brand = Brands.UnderArmour, Length = 20, Price = 2.10m, ImageURL = "Ben10.jpg"},
                new Lace {Colour = Colours.Pink, Brand = Brands.Fila, Length = 10, Price = 4.99m, ImageURL = "RedAgain.jpg", Description = "A great lace"},
                new Lace {Colour = Colours.Yellow, Brand = Brands.Adidas, Length = 15, Price = 4.50m, ImageURL = "Print.jpg", Description = "One of a kind"},
                new Lace {Colour = Colours.Green, Brand = Brands.UnderArmour, Length = 19, Price = 1.80m, ImageURL = "Metal.jpg", Description = "Simply the best"},
                new Lace {Colour = Colours.Black, Brand = Brands.Lacoste, Length = 12, Price = 2.25m, ImageURL = "LovelyLaces.jpg", Description = "Sporty and colourful"},
                new Lace {Colour = Colours.Cyan, Brand = Brands.Puma, Length = 15, Price = 2.50m, ImageURL = "Hipster.jpg", Description = "On the older range of laces but the quality still holds up today"},
                new Lace {Colour = Colours.Red, Brand = Brands.Champion, Length = 11, Price = 3.45m, ImageURL = "GreyShoe.jpg", Description = "Made for Champions"},
                new Lace {Colour = Colours.Green, Print = "Who Dat Boi", Brand = Brands.Ellesse, Length = 22, Price = 0.99m, ImageURL = "greenish.jpg", Description = "Who him is?"},
                new Lace {Colour = Colours.Pink, Print = "Happy Birthday", Brand = Brands.Adidas, Length = 10, Price = 1.99m, ImageURL = "GenericLace.jpg", Description="A quality durable lace"},
                new Lace {Colour = Colours.Blue, Brand = Brands.Champion, Length = 16, Price = 2.99m, ImageURL = "DisShoe.jpg", Description = "A new and exciting pink lace"},
                new Lace {Colour = Colours.Purple, Print = "Hello", Brand = Brands.Kappa, Length = 14,Price = 2.00m, ImageURL = "DatShoe.jpg", Description=" Affordable and stylish"},
                new Lace {Colour = Colours.White, Brand = Brands.Reebok, Length = 10, Price = 2.80m, ImageURL = "darkgreenish.jpg", Description = "A Classic!!!"},
                new Lace {Colour = Colours.Grey, Brand = Brands.Fila, Length = 11, Price = 1.00m, ImageURL = "DarkColours.jpg", Description="A colourful lace for any shoe"},
                new Lace {Colour = Colours.Pink, Print = "Kick it", Brand = Brands.Nike, Length = 14, Price = 4.20m, ImageURL = "BlueShoe.jpg", Description="Elegant and functional"},
                new Lace {Colour = Colours.Yellow, Print = "Congrats Johny", Brand = Brands.Jordan, Length = 5,Price = 3.00m,  ImageURL = "Bluely.jpg", Description = "A good lace to gift to someone special"},
                new Lace {Colour = Colours.Blue, Brand = Brands.Puma, Length = 17, Price = 3.25m, ImageURL = "AllShoes.jpg", Description="The perfect everyday lace"},
                new Lace {Colour = Colours.Pink, Brand = Brands.Reebok, Length = 11, Price = 2.750m, ImageURL = "BlackLace.jpg", Description="The lace that will make your shoes"},
                new Lace {Colour = Colours.Cyan, Print = "Happy Mothers Day", Brand = Brands.Adidas, Length = 15,Price = 1.50m, ImageURL = "Aglets.jpg", Description = "For that special day"},
                new Lace {Colour = Colours.Yellow, Brand = Brands.Fila, Length = 10,Price = 2.50m, ImageURL = "Green.jpg", Description="Blend into nature with our green lace"}
            };
        ...
        private static void InitialiseItems(ApplicationDbContext context)
        {
            ...
            var items = new Item[]
            {
                new Item{Quantity = 3, Total = 20.50m, LaceID = 1, OrderID = 1,},
                new Item{Quantity = 1, Total = 5m, LaceID = 3, OrderID = 2,},
                new Item{Quantity = 15, Total = 45.30m, LaceID = 5, OrderID = 3,},
                new Item{Quantity = 6, Total = 19.00m, LaceID = 2, OrderID = 4,},
                new Item{Quantity = 8, Total = 33.00m, LaceID = 10, OrderID = 5,},
                new Item{Quantity = 1, Total = 2.00m, LaceID = 11, OrderID = 6,},
                new Item{Quantity = 9, Total = 18.00m, LaceID = 6, OrderID = 7,},
                new Item{Quantity = 20, Total = 55.00m, LaceID = 1, OrderID = 8,},
                new Item{Quantity = 90, Total = 115.36m, LaceID = 15, OrderID = 9,},
                new Item{Quantity = 4, Total = 8.25m, LaceID = 20, OrderID = 10,},
                new Item{Quantity = 6, Total = 11.70m, LaceID = 14, OrderID = 11,},
                new Item{Quantity = 14, Total = 16.40m, LaceID = 7, OrderID = 12,},
                new Item{Quantity = 7, Total = 9.25m, LaceID = 4, OrderID = 13,},
                new Item{Quantity = 10, Total = 31.05m, LaceID = 11, OrderID = 14,},
                new Item{Quantity = 30, Total = 64.21m, LaceID = 18, OrderID = 15,},
                new Item{Quantity = 26, Total = 44.00m, LaceID = 13, OrderID = 16,},
                new Item{Quantity = 8, Total = 24.99m, LaceID = 2, OrderID = 17,},
                new Item{Quantity = 2, Total = 4.50m, LaceID = 5, OrderID = 18,},
                new Item{Quantity = 1, Total = 3.60m, LaceID = 19, OrderID = 19,},
                new Item{Quantity = 5, Total = 8.99m, LaceID = 8, OrderID = 20,},
