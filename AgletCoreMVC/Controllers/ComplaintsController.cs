...
namespace AgletCoreMVC.Controllers
{
    public class ComplaintsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ComplaintID,Title,Body,ImageUrl")] Complaint complaint)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ComplaintID,Title,Body,ImageUrl")] Complaint complaint)
        {
