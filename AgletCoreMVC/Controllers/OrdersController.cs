...
namespace AgletCoreMVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,DateOrdered,Status,SubTotal,UserID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,DateOrdered,Status,SubTotal,UserID")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
